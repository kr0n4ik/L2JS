const L2Packet = require('./L2Packet');
...
class L2Client {
	...
	LoginOk() {
		console.log("loginokID1: " + this.loginOkID1.toString(16) + " 2: " + this.loginOkID2.toString(16));
		let packet = new L2Packet();
		packet.writeC(0x03);
	...
	PlayOk() {
		console.log("playokID1: " + this.playOkID1.toString(16) + " 2: " + this.playOkID2.toString(16));
		let packet = new L2Packet();
		packet.writeC(0x07);
